...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "release-1.11.0"
  WORKING_DIRECTORY "/Users/tarasneridnyi/Desktop/Lab6_1_it/cmake-build-debug/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/tarasneridnyi/Desktop/Lab6_1_it/cmake-build-debug/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/tarasneridnyi/Desktop/Lab6_1_it/cmake-build-debug/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
